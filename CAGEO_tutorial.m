...
% The preferred way of installing, if you are not interested in
% editing the source code. Here is the link to the *.tlbx file:
web('https://github.com/HarvardPaleomag/QDMlab/releases')
